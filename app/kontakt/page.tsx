  ...
  return (
    <>
      <PageHero
        eyebrow="Kontakt"
        number="Kapitel 07"
        title={<>Schreiben, anrufen, <em className="font-display-italic text-accent-deep">vorbeikommen.</em></>}
      ...
      <section className="section-y">
        <div className="container-x grid lg:grid-cols-[1fr_1.2fr] gap-10 md:gap-16">
          <div>
            <SectionEyebrow accent>So erreichen Sie uns</SectionEyebrow>
            <h2 className="h-section mt-4">
              Restaurant <em className="font-display-italic text-accent-deep">Hoffschulte.</em>
            </h2>
            ...
            <dl className="mt-12 space-y-7 text-[15.5px]">
              ...
              <div className="grid grid-cols-[24px_1fr] gap-5 items-start">
                ...
                <dd>
                  <a
                    ...
                    className="text-text hover:text-accent-deep"
                  >
              ...
              <div className="grid grid-cols-[24px_1fr] gap-5 items-start">
                ...
                <dd>
                  <a href={`mailto:${site.email}`} className="text-text hover:text-accent-deep break-all">
                    {site.email}
                  </a>
                </dd>
              </div>
              <div className="grid grid-cols-[24px_1fr] gap-5 items-start">
                ...
                <dd className="text-text leading-relaxed">
                  Fr & Sa · <span className="font-display-italic text-accent-deep">{site.hours.fridaySaturday}</span><br />
                  So & Feiertag · <span className="font-display-italic text-accent-deep">{site.hours.sundayHoliday}</span><br />
          ...
          <div className="lg:pl-12 lg:border-l lg:border-[color:var(--line-strong)]">
            ...
            <h2 className="h-section mt-4 mb-8">
              Wir antworten <em className="font-display-italic text-accent-deep">persönlich.</em>
            </h2>
            <ContactForm />
          </div>
        </div>
      ...
      <section className="border-t border-[color:var(--line)]">
        <div className="relative h-[60vh] min-h-[420px] w-full">
          <iframe
            ...
            className="absolute inset-0 w-full h-full grayscale-[35%] contrast-105"
          />
        </div>
      </section>
    </>
